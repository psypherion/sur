...
if __name__ == "__main__":
    ...
    # --- 2D UMAP ---
    vis2d = GTZANManifold(n_components=2, model_name="gtzan_umap_vis_2d", n_neighbors=50, min_dist=0.2)
    vis2d.fit()
    vis2d.save()
    print("2D UMAP for visualization (n_neighbors=50, min_dist=0.2) saved.")
    ...
    # --- 3D UMAP ---
    vis3d = GTZANManifold(n_components=3, model_name="gtzan_umap_vis_3d", n_neighbors=50, min_dist=0.2)
    vis3d.fit()
    vis3d.save()
    print("3D UMAP for visualization (n_neighbors=50, min_dist=0.2) saved.")
