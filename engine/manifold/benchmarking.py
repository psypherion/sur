...
def run_umap_sweep(loader, n_neighbors_list, min_dist_list, n_components=50):
    ...
    for n_neighbors in n_neighbors_list:
        for min_dist in min_dist_list:
            ...
            # Save metrics for later summary
...
if __name__ == "__main__":
    ...
    # Set higher dimension for more ML structure
    n_components = 50

    results_df = run_umap_sweep(loader, n_neighbors_list, min_dist_list, n_components=n_components)
    print("\n\n==== Sweep Summary Table ====\n")
    print(results_df)
